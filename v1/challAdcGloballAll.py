...
BASE_DIR = 'lol_data'
CSV_FILE = f'{BASE_DIR}/chall_adc_global_all_stats_2026.csv'

os.makedirs(BASE_DIR, exist_ok=True)
for reg in chall_adc:
...
BASE_COLUMNS = [
    # "jugador", "match_id", "side", "teamPosition", "individualPosition", "championName", "win", "kills", "deaths", "assists", "kda", "killParticipation", "cs/min", "totalMinionsKilled", "neutralMinionsKilled", "visionScore", "wardsPlaced", "visionWardsBoughtInGame", "wardsKilled", "goldEarned", "goldSpent", "champExperience", "champLevel", "totalDamageDealtToChampions", "physicalDamageDealtToChampions", "magicDamageDealtToChampions", "trueDamageDealtToChampions", "damageDealtToTurrets", "damageDealtToObjectives", "damageDealtToBuildings", "totalDamageTaken", "physicalDamageTaken", "magicDamageTaken", "trueDamageTaken", "damageSelfMitigated", "totalHeal", "totalHealsOnTeammates", "totalDamageShieldedOnTeammates", "timeCCingOthers", "totalTimeCCDealt", "totalTimeSpentDead", "longestTimeSpentLiving", "largestKillingSpree", "largestMultiKill", "largestCriticalStrike", "doubleKills", "tripleKills", "quadraKills", "pentaKills", "firstBloodKill", "firstBloodAssist", "firstTowerKill", "firstTowerAssist", "turretKills", "turretTakedowns", "inhibitorKills", "inhibitorTakedowns", "baronKills", "dragonKills", "riftHeraldKills", "objectivesStolen", "objectivesStolenAssists", "soloKills", "multikills", "killingSprees", "allInPings", "assistMePings", "basicPings", "commandPings", "dangerPings", "enemyMissingPings", "enemyVisionPings", "getBackPings", "holdPings", "needVisionPings", "onMyWayPings", "pushPings", "retreatPings", "visionClearedPings", "consumablesPurchased", "detectorWardsPlaced", "itemsPurchased", "spell1Casts", "spell2Casts", "spell3Casts", "spell4Casts", "summoner1Casts", "summoner2Casts", "summoner1Id", "summoner2Id", "item0", "item1", "item2", "item3", "item4", "item5", "item6", "timePlayed", "totalUnitsHealed", "totalAllyJungleMinionsKilled", "totalEnemyJungleMinionsKilled", "turretPlatesTaken", "turretsLost", "unrealKills"
    'jugador', 'match_id', 'side', 'teamPosition', 'individualPosition', 'championName', 'win', 'kills', 'deaths', 'assists', 'kda', 'killParticipation', 'cs/min', 'totalMinionsKilled', 'neutralMinionsKilled', 'visionScore', 'wardsPlaced', 'visionWardsBoughtInGame', 'wardsKilled', 'goldEarned', 'goldSpent', 'champExperience', 'champLevel', 'totalDamageDealtToChampions', 'physicalDamageDealtToChampions', 'magicDamageDealtToChampions', 'trueDamageDealtToChampions', 'damageDealtToTurrets', 'damageDealtToObjectives', 'damageDealtToBuildings', 'totalDamageTaken', 'physicalDamageTaken', 'magicDamageTaken', 'trueDamageTaken', 'damageSelfMitigated', 'totalHeal', 'totalHealsOnTeammates', 'totalDamageShieldedOnTeammates', 'timeCCingOthers', 'totalTimeCCDealt', 'totalTimeSpentDead', 'longestTimeSpentLiving', 'largestKillingSpree', 'largestMultiKill', 'largestCriticalStrike', 'doubleKills', 'tripleKills', 'quadraKills', 'pentaKills', 'firstBloodKill', 'firstBloodAssist', 'firstTowerKill', 'firstTowerAssist', 'turretKills', 'turretTakedowns', 'inhibitorKills', 'inhibitorTakedowns', 'baronKills', 'dragonKills', 'riftHeraldKills', 'objectivesStolen', 'objectivesStolenAssists', 'soloKills', 'multikills', 'killingSprees', 'allInPings', 'assistMePings', 'basicPings', 'commandPings', 'dangerPings', 'enemyMissingPings', 'enemyVisionPings', 'getBackPings', 'holdPings', 'needVisionPings', 'onMyWayPings', 'pushPings', 'retreatPings', 'visionClearedPings', 'consumablesPurchased', 'detectorWardsPlaced', 'itemsPurchased', 'spell1Casts', 'spell2Casts', 'spell3Casts', 'spell4Casts', 'summoner1Casts', 'summoner2Casts', 'summoner1Id', 'summoner2Id', 'item0', 'item1', 'item2', 'item3', 'item4', 'item5', 'item6', 'timePlayed', 'totalUnitsHealed', 'totalAllyJungleMinionsKilled', 'totalEnemyJungleMinionsKilled', 'turretPlatesTaken', 'turretsLost', 'unrealKills'
]
    ...
    try:
        ...
        for p in info['participants']:
            if p['puuid'] == puuid_jugador:
                ...
                # === Es ADC → extraer TODAS las stats ===
                row = {}
                row["jugador"] = riot_id
                row["match_id"] = m_id
...
print("🚀 SCRAPER ADC TOP – CSV MÁXIMO COMPLETO\n")

for reg_name, players in chall_adc.items():
